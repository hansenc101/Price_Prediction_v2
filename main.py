...
config = Config(n_input_size=input_size, hidden_size=50, n_layers=3, lr=1e-4, dropout=0.1)
...
plt.plot(Days, val_target[-1*n_days:-1], label='Actual Stock Price')
plt.plot(Days, val_pred[-1*n_days:-1], label='Predicted Stock Price')
plt.xlabel('Days')
